...
@interface MainPageBarCollectionView()
...
@implementation MainPageBarCollectionView
...
- (instancetype)initialize:(MainPageBarCollectionView *)instance {
...
- (MainPageBarItemCollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    MainPageBarItemCollectionViewCell *item = [collectionView dequeueReusableCellWithReuseIdentifier:@"item" forIndexPath:indexPath];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    [self.mainPageBarDelegate onMainPageBarSelect:indexPath.row];
